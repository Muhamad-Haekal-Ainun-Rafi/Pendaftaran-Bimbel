package com.lailatul.bimbel.Setting;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private EditText iNama,iTgl,iSekolah,iAlamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = ProgressDialog.show(SettingActivity.this,
                "",
                "Please wait...",
                true,
                false);
        ...
        iTgl = findViewById(R.id.setting_tgl);
        iSekolah = findViewById(R.id.setting_sekolah);
        iAlamat = findViewById(R.id.setting_alamat);
        ...
        database.child(Uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String Gsekolah = dataSnapshot.child("sekolah").getValue(String.class);
                String Gtanggal_lahir = dataSnapshot.child("tanggal_lahir").getValue(String.class);
                ...
                if (Gfoto.isEmpty()){
                    ...
                    iSekolah.setText(Gsekolah);
                    iTgl.setText(Gtanggal_lahir);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String Isekolah = iSekolah.getText().toString();
                final String Itanggal_lahir = iTgl.getText().toString();
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (connected){
                            ...
                            if (uploadTask!=null && uploadTask.isInProgress()){
                                Toast.makeText(SettingActivity.this,"Upload foto...", Toast.LENGTH_LONG).show();
                            }
                                                ...
                                                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        editAkun(new Request(
                                                                Inama,Ialamat,Isekolah,Itanggal_lahir,Iemail,Ifoto));
                                                    }
                                                });
                                            }
                                        })
        ...
        database.child(Uid)
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        loading.dismiss();
                        Toast.makeText(SettingActivity.this, "Data di update!", Toast.LENGTH_SHORT).show();
                        finish();
                        return;
                    }
                });
